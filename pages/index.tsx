...
export default function Welcome() {
  ...
  return (
    <>
      <Head>
        <title>SCheck</title>
        <meta name="description" content="SCheck" />
      ...
      <div className={styles.section}>
        <div className={styles.text}>
          ...
          <p className="py-4">
            SCheck is a platform that empowers your community to take more
            control over the issues that affect you. Join SCheck and read
            ...
            benefitting the whole community. SCheck gives everybody a vote and a voice.
          </p>
          <div className="pt-4">
